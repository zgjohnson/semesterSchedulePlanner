...
class registrationRequest(models.Model):
    proposedUsername = models.CharField(maxlength=20, null=False)
...
class sspCredential (models.Model):
    userName = models.CharField(maxlength=20, null=False)
    password = models.CharField(maxlength=20, null=False)
    emailAddress = models.EmailField(max_length=254, null=False, primary_key=True)
